<%@ page language="VB" masterpagefile="~/Forms/MasterPage.master" autoeventwireup="false" inherits="Forms_frmAdvertiserProject, App_Web_qbwzvytd" title="IP Tracking Admin System - Project" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <table style="width: 600px; font-size: 9pt; font-family: Arial;">
        ...
        <tr style="color: #000000">
            <td align="right" style="font-size: 9pt; width: 200px; font-family: Arial">
                <asp:Label ID="lblAdProjectADUrl" runat="server" Text="Advertising Url:"></asp:Label></td>
            <td align="left" style="width: 400px" colspan="2">
        ...
        <tr>
            ...
            <td align="left" style="width: 400px" colspan="2"><asp:DropDownList ID="ddlAdProjectVerifiedMonth" runat="server" Width="116px">
                <asp:ListItem>Month</asp:ListItem>
                <asp:ListItem Value="01">January</asp:ListItem>
                <asp:ListItem Value="02">February </asp:ListItem>
                <asp:ListItem Value="03">March</asp:ListItem>
                ...
                <asp:DropDownList ID="ddlAdProjectVerifiedDay" runat="server" Width="50px">
                    <asp:ListItem>Day</asp:ListItem>
                    <asp:ListItem>01</asp:ListItem>
                    <asp:ListItem>02</asp:ListItem>
                    <asp:ListItem>03</asp:ListItem>
                ...
                ,
                <asp:DropDownList ID="ddlAdProjectVerifiedYear" runat="server" Width="78px">
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td align="left" style="width: 400px" colspan="2"><asp:DropDownList ID="ddlAdProjectOnlineMonth" runat="server" Width="116px">
                <asp:ListItem>Month</asp:ListItem>
                <asp:ListItem Value="01">January</asp:ListItem>
                <asp:ListItem Value="02">February </asp:ListItem>
                <asp:ListItem Value="03">March</asp:ListItem>
                ...
                <asp:DropDownList ID="ddlAdProjectOnlineDay" runat="server" Width="50px">
                    <asp:ListItem>Day</asp:ListItem>
                    <asp:ListItem>01</asp:ListItem>
                    <asp:ListItem>02</asp:ListItem>
                    <asp:ListItem>03</asp:ListItem>
                ...
                ,
                <asp:DropDownList ID="ddlAdProjectOnlineYear" runat="server" Width="78px">
                </asp:DropDownList>
