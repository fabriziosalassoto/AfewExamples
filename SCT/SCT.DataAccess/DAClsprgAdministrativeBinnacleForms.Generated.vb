...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsprgAdministrativeBinnacleForms
    ...
    <Serializable()> Public Class Struct
        Public TableName As String = "prgAdministrativeBinnacleForms"
    ...
    Private Shared Function CreateSql(ByVal ParamArray pParametersList() As String) As String
        ...
        sql &= "  BHour"
        sql &= " From"
        sql &= "  prgAdministrativeBinnacleForms"
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into prgAdministrativeBinnacleForms"
        sql &= "  ("
        sql &= "    IDBinnacle,"
        sql &= "    IDForm,"
        sql &= "    IDOperation,"
    ...
    Public Shared Function Update(ByVal pStruct As Struct) As Struct
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " UPDATE prgAdministrativeBinnacleForms"
        sql &= " SET"
        ...
        sql &= "  BHour = '" & Format(pStruct.BHour.NewValue, "HH:mm:ss") & "'"
        sql &= " Where"
    ...
    Public Shared Sub Delete(ByVal pID As Long)
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " Delete From prgAdministrativeBinnacleForms"
        sql &= " Where"
        sql &= "  ID = " & pID.ToString
