...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsprgAdvertiserBinnacleFormFields
    ...
    <Serializable()> Public Class Struct
        ...
        Public TableName As String = "prgAdvertiserBinnacleFormFields"
    ...
    Private Shared Function CreateSql(ByVal ParamArray pParametersList() As String) As String
        ...
        sql &= "  NewValue"
        sql &= " From"
        sql &= "  prgAdvertiserBinnacleFormFields"
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into prgAdvertiserBinnacleFormFields"
        sql &= "  ("
        sql &= "    IDBinnacleForm,"
        sql &= "    IDField,"
        sql &= "    OldValue,"
    ...
    Public Shared Function Update(ByVal pStruct As Struct) As Struct
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " UPDATE prgAdvertiserBinnacleFormFields"
        sql &= " SET"
    ...
    Public Shared Sub Delete(ByVal pID As Long)
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " Delete From prgAdvertiserBinnacleFormFields"
        sql &= " Where"
        sql &= "  ID = " & pID.ToString
