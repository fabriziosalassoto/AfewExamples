...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsprgAdministrativeBinnacleTables
    ...
    <Serializable()> Public Class Struct
        Public TableName As String = "prgAdministrativeBinnacleTables"
    ...
    Private Shared Function CreateSql(ByVal ParamArray pParametersList() As String) As String
        ...
        sql &= "  BHour"
        sql &= " From"
        sql &= "  prgAdministrativeBinnacleTables"
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into prgAdministrativeBinnacleTables"
        sql &= "  ("
        sql &= "    IDBinnacle,"
        sql &= "    IDOperation,"
        sql &= "    TableName,"
    ...
    Public Shared Function Update(ByVal pStruct As Struct) As Struct
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " UPDATE prgAdministrativeBinnacleTables"
        sql &= " SET"
    ...
    Public Shared Sub Delete(ByVal pID As Long)
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " Delete From prgAdministrativeBinnacleTables"
        sql &= " Where"
        sql &= "  ID = " & pID.ToString
