...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsprgSubscriberBinnacleTables
    ...
    <Serializable()> Public Class Struct
        ...
        Public TableName As String = "prgSubscriberBinnacleTables"
    ...
    Private Shared Function CreateSql(ByVal ParamArray pParametersList() As String) As String
        ...
        sql &= "  BHour"
        sql &= " From"
        sql &= "  prgSubscriberBinnacleTables"
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into prgSubscriberBinnacleTables"
        sql &= "  ("
        sql &= "    IDBinnacle,"
        sql &= "    IDOperation,"
        sql &= "    TableName,"
    ...
    Public Shared Function Update(ByVal pStruct As Struct) As Struct
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " UPDATE prgSubscriberBinnacleTables"
        sql &= " SET"
    ...
    Public Shared Sub Delete(ByVal pID As Long)
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " Delete From prgSubscriberBinnacleTables"
        sql &= " Where"
        sql &= "  ID = " & pID.ToString
