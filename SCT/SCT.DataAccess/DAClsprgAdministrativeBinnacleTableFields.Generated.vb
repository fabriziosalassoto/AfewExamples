...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsprgAdministrativeBinnacleTableFields
    ...
    <Serializable()> Public Class Struct
        ...
        Public TableName As String = "prgAdministrativeBinnacleTableFields"
    ...
    Private Shared Function CreateSql(ByVal ParamArray pParametersList() As String) As String
        ...
        sql &= "  NewValue"
        sql &= " From"
        sql &= "  prgAdministrativeBinnacleTableFields"
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into prgAdministrativeBinnacleTableFields"
        sql &= "  ("
        sql &= "    IDBinnacleTable,"
        sql &= "    FieldName,"
        sql &= "    OldValue,"
    ...
    Public Shared Function Update(ByVal pStruct As Struct) As Struct
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " UPDATE prgAdministrativeBinnacleTableFields"
        sql &= " SET"
    ...
    Public Shared Sub Delete(ByVal pID As Long)
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " Delete From prgAdministrativeBinnacleTableFields"
        sql &= " Where"
        sql &= "  ID = " & pID.ToString
