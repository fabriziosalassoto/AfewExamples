...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsprgAdvertiserBinnacle
    ...
    <Serializable()> Public Class Struct
        ...
        Public TableName As String = "prgAdvertiserBinnacle"
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into prgAdvertiserBinnacle"
        sql &= "  ("
        sql &= "    IDUser,"
        sql &= "    BDate"
        sql &= "  )"
    ...
    Public Shared Function Update(ByVal pStruct As Struct) As Struct
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " UPDATE prgAdvertiserBinnacle"
        sql &= " SET"
    ...
    Public Shared Sub Delete(ByVal pID As Long)
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " Delete From prgAdvertiserBinnacle"
        sql &= " Where"
        sql &= "  ID = " & pID.ToString
