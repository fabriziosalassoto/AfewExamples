...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsprgAdministrativeGroupPermissions
    ...
    <Serializable()> Public Class Struct
        Public TableName As String = "prgAdministrativeGroupPermissions"

        Public IDProfile As StructField(Of Long) = New StructField(Of Long)("IDProfile", True)
        Public IDGroup As StructField(Of Long) = New StructField(Of Long)("IDGroup", True)
    ...
    ''' <returns>List of DAClsAdministratorGroupPermissions.Struct with the read registries</returns>
    ''' <remarks></remarks>
    Public Shared Function Fetch(ByVal pIDGroup As Long, ByVal pIDProfile As Long, ByVal pIDForm As Long) As Struct()
        Fetch = DoFetch(CreateSelectSql(GetParamsList(pIDProfile, pIDForm, pIDGroup)))
    End Function
    ...
    ''' <returns>List of DAClsAdministratorGroupPermissions.Struct with the read registries</returns>
    ''' <remarks></remarks>
    Public Shared Function FetchByGroup(ByVal pIDGroup As Long) As Struct()
        FetchByGroup = DoFetch(CreateSelectSql("IDGroup = " & pIDGroup.ToString))
    End Function
    ...
    ''' <returns>List of DAClsAdministratorGroupPermissions.Struct with the read registries</returns>
    ''' <remarks></remarks>
    Public Shared Function FetchByFormPermissions(ByVal pIDProfile As Long, ByVal pIDForm As Long) As Struct()
        FetchByFormPermissions = DoFetch(CreateSelectSql("IDProfile = " & pIDProfile.ToString, "IDForm = " & pIDForm.ToString))
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Shared Function GetParamsList(ByVal pIDProfile As Long, ByVal pIDForm As Long, ByVal pIDGroup As Long) As String()
        ...
        If pIDGroup <> 0 Then
            params.Add("IDGroup = " & pIDGroup.ToString)
        End If
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Shared Function GetParamsList(ByVal pIDProfiles() As Long, ByVal pIDForms() As Long, ByVal pIDGroups() As Long) As String()()
        ...
        If pIDGroups.Length > 0 Then
            Dim paramList As New List(Of String)
            For Each idGroup As Long In pIDGroups
                If idGroup <> 0 Then
                    paramList.Add("IDGroup = " & idGroup.ToString)
                End If
            Next
            paramsList.Add(paramList.ToArray)
        End If
    ...
    Private Shared Function CreateSelectSql(ByVal ParamArray pParams() As String) As String
        ...
        sql &= "  PDelete"
        sql &= " From"
        sql &= "  prgAdministrativeGroupPermissions"
    ...
    Private Shared Function DoFetch(ByVal psql As String) As Struct()
        ...
        Using DBConn As DBClsConnection = New DBClsConnection(DADataBase.SCTConnectionString)
            ...
            Using dr As SafeDataReader = DBConn.ExecuteReader(psql)
                ...
                While dr.Read()
                    Struct = New Struct
                    Struct.IDGroup.SetValue(dr.GetInt64("IDGroup"))
    ...
    Private Shared Function RefreshStruct(ByVal pStruct As Struct) As Struct
        ...
        pStruct.IDGroup.OldValue = pStruct.IDGroup.Value
        pStruct.IDGroup.Value = pStruct.IDGroup.NewValue
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into prgAdministrativeGroupPermissions"
        sql &= "  ("
        sql &= "    IDGroup,"
        sql &= "    IDProfile,"
        sql &= "    IDForm,"
        ...
        sql &= " Values"
        sql &= "  ("
        sql &= "    " & pStruct.IDGroup.NewValue.ToString & ","
    ...
    Public Shared Function Update(ByVal pStruct As Struct) As Struct
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " UPDATE prgAdministrativeGroupPermissions"
        sql &= " SET"
        ...
        sql &= " Where IDGroup = " & pStruct.IDGroup.NewValue.ToString
        sql &= "   And IDProfile = " & pStruct.IDProfile.NewValue.ToString
    ...
    ''' <param name="pIDForm">IDForm to use</param>
    ''' <remarks></remarks>
    Public Shared Sub Delete(ByVal pIDGroup As Long, ByVal pIDProfile As Long, ByVal pIDForm As Long)
        DoDelete(CreateDeleteSql("IDGroup = " & pIDGroup.ToString, "IDProfile = " & pIDProfile.ToString, "IDForm = " & pIDForm.ToString))
    End Sub
    ...
    ''' <remarks></remarks>
    Public Shared Sub DeleteByGroup(ByVal pIDGroup As Long)
        DoDelete(CreateDeleteSql("IDGroup = " & pIDGroup.ToString))
    End Sub
    ...
    ''' <param name="pIDForm"></param>
    ''' <remarks></remarks>
    Public Shared Sub DeleteByFormPermission(ByVal pIDProfile As Long, ByVal pIDForm As Long)
