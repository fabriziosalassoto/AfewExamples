...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsappAdvertiserDemographics
    ...
    <Serializable()> Public Class Struct
        Public TableName As String = "appAdvertiserDemographics"
        ...
        Public DemographicRequirement As StructField(Of String) = New StructField(Of String)("DemographicRequirement", False, String.Empty)
    End Class
    ...
    ''' <returns>List of DAClsAdvertiserDemographic.Struct with the read registries</returns>
    ''' <remarks></remarks>
    Public Shared Function Fetch(ByVal pIDAdvertiserProject As Long, ByVal pDemographicTag As String) As Struct()
        Fetch = DoFetch(CreateSql(GetParamsList(pIDAdvertiserProject, pDemographicTag)))
    End Function
    ...
    ''' <remarks></remarks>
    Public Shared Function FetchProjectDemographics(ByVal pIDProject As Long) As Struct()
        FetchProjectDemographics = DoFetch(CreateSql("IDAdvertiserProject = " & pIDProject.ToString))
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Shared Function GetParamsList(ByVal pIDAdvertiserProject As Long, ByVal pDemographicTag As String) As String()
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Shared Function GetParamsList(ByVal pIDAdvertiserProjects() As Long, ByVal pDemographicTags() As String) As String()()
    ...
    Private Shared Function CreateSql(ByVal ParamArray pParams() As String) As String
        ...
        sql &= "  DemographicTag,"
        sql &= "  DemographicRequirement"
        sql &= " From"
        sql &= "  appAdvertiserDemographics"
        ...
        Using DBConn As DBClsConnection = New DBClsConnection(DADataBase.SCTConnectionString)
            ...
            Using dr As SafeDataReader = DBConn.ExecuteReader(psql)
                ...
                While dr.Read()
                    ...
                    Struct.DemographicRequirement.SetValue(dr.GetString("DemographicRequirement"))
                    List.Add(Struct)
                End While
    ...
    Private Shared Function RefreshStruct(ByVal pStruct As Struct) As Struct
        ...
        pStruct.DemographicRequirement.OldValue = pStruct.DemographicRequirement.Value
        pStruct.DemographicRequirement.Value = pStruct.DemographicRequirement.NewValue
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into appAdvertiserDemographics"
        sql &= "  ("
        sql &= "    IDAdvertiserProject,"
        sql &= "    DemographicTag,"
        sql &= "    DemographicRequirement"
        ...
        sql &= "    '" & pStruct.DemographicRequirement.NewValue & "'"
        sql &= "  );"
    ...
    Public Shared Sub Delete(ByVal pID As Long)
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " Delete From appAdvertiserDemographics"
        sql &= " Where"
        sql &= "  ID = " & pID.ToString
