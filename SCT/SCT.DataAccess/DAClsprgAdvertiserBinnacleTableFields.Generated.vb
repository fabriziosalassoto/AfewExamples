...
''' </summary>
''' <remarks></remarks>
<Serializable()> Public Class DAClsprgAdvertiserBinnacleTableFields
    ...
    Private Shared Function CreateSql(ByVal ParamArray pParametersList() As String) As String
        ...
        sql &= "  NewValue"
        sql &= " From"
        sql &= "  prgAdvertiserBinnacleTableFields"
    ...
    Public Shared Function Insert(ByVal pStruct As Struct) As Struct
        ...
        Dim sql As String = ""
        sql &= " Insert Into prgAdvertiserBinnacleTableFields"
        sql &= "  ("
        sql &= "    IDBinnacleTable,"
        sql &= "    FieldName,"
        sql &= "    OldValue,"
    ...
    Public Shared Function Update(ByVal pStruct As Struct) As Struct
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " UPDATE prgAdvertiserBinnacleTableFields"
        sql &= " SET"
    ...
    Public Shared Sub Delete(ByVal pID As Long)
        ...
        'Build SQL value
        Dim sql As String = ""
        sql &= " Delete From prgAdvertiserBinnacleTableFields"
        sql &= " Where"
        sql &= "  ID = " & pID.ToString
