                    ...
                    <table style="width: 100%; height: 200pt">
                        <tr>
                            <td align="right" style="border-right: silver 1px solid; font-weight: bold; font-size: 15pt; color: black; font-family: 'Comic Sans MS'">
                                ...
                                <br />
                                &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<asp:Button ID="cmdSignUp"
                                    runat="server" BackColor="DimGray" BorderColor="Black" BorderStyle="Outset" BorderWidth="1px"
                                    Font-Names="Arial" Font-Size="9pt" ForeColor="White" Text="Sign Up Now" Width="120px" CausesValidation="False" />
                                &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td>
                            <td align="left" style="font-weight: normal; font-size: 12pt; color: black; font-family: 'Comic Sans MS'">
                                &nbsp;&nbsp; Sign In as Advertiser<br />
                                <table>
                                    <tr>
                                ...
                                <asp:Button ID="cmdSignIn" runat="server" BackColor="DimGray" BorderColor="Black"
                                    ...
                                    ForeColor="White" Text="Sign In" Width="120px" /><cc1:MsgBox ID="MsgBox" runat="server" BorderStyle="None" />
                            </td>
                        </tr>
                    </table>
                    <br />
