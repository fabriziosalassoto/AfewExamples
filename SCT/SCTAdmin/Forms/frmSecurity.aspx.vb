...
Partial Class frmSecurity
    ...
    Private wcForm As SCT.Admin.DataFlow.DFClsSecurity
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Me.wcForm = New SCT.Admin.DataFlow.DFClsSecurity(Me)
        Else
            If SCT.Library.AdminSite.ClsSessionAdmin.SessionCurrentClsForm Is Nothing OrElse SCT.Library.AdminSite.ClsSessionAdmin.SessionCurrentClsForm.GetType().Name <> "DFClsSecurity" Then
                Me.wcForm = New SCT.Admin.DataFlow.DFClsSecurity(Me)
            Else
