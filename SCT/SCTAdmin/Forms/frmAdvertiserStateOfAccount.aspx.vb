...
Partial Class Forms_frmAdvertiserStateOfAccount
    Inherits System.Web.UI.Page

    Private wcForm As SCT.Admin.DataFlow.DFClsAdvertiserStateOfAccount
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Me.wcForm = New SCT.Admin.DataFlow.DFClsAdvertiserStateOfAccount(Me)
        Else
            If SCT.Library.AdminSite.ClsSessionAdmin.SessionCurrentClsForm Is Nothing OrElse SCT.Library.AdminSite.ClsSessionAdmin.SessionCurrentClsForm.GetType.Name <> "DFClsAdvertiserStateOfAccount" Then
                Me.wcForm = New SCT.Admin.DataFlow.DFClsAdvertiserStateOfAccount(Me)
            Else
    ...
    Protected Sub grdAdvertiserTransactions_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdTransactions.RowDataBound
        SCT.Admin.DataFlow.DFClsAdvertiserTransactions.ApplyGridRowAuthorizationRules(CType(sender, GridView), e.Row)
    End Sub

    Protected Sub grdAdvertiserTransactions_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles grdTransactions.Sorting
    ...
    Protected Sub grdAdvertiserTransactions_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles grdTransactions.PageIndexChanging
