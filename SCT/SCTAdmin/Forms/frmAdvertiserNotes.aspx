<%@ Page Language="VB" MasterPageFile="~/Forms/MasterPage.master" AutoEventWireup="false" CodeFile="frmAdvertiserNotes.aspx.vb" Inherits="Forms_frmAdvertiserNotes" title="IP Tracking Admin System - Notes" %>
        ...
        <tr>
            <td style="font-size: 10pt; font-family: Arial; text-align: right">
                <asp:CustomValidator ID="csvStartDate" runat="server" ErrorMessage="* Invalid Start Entered Date."
                    Font-Bold="True" Font-Names="Arial" Font-Size="Large" ForeColor="OrangeRed" Display="Dynamic" SetFocusOnError="True">*</asp:CustomValidator>Start
                Entered Date:</td>
            <td contenteditable="true" rowspan="1" style="font-size: 10pt; vertical-align: top;
                font-family: Arial; text-align: left">
            ...
            <td style="font-size: 10pt; font-family: Arial; text-align: right">
                <asp:CustomValidator ID="csvEndDate" runat="server" ErrorMessage="* Invalid End Entered Date."
                    Font-Bold="True" Font-Names="Arial" Font-Size="Large" ForeColor="OrangeRed" Display="Dynamic" SetFocusOnError="True">*</asp:CustomValidator>End
                Entered Date:</td>
            <td style="font-size: 10pt; vertical-align: top; font-family: Arial; text-align: left">
