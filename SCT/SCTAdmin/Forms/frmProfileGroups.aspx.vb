...
Partial Class Forms_frmProfileGroups
    Inherits System.Web.UI.Page

    Private wcForm As SCT.Admin.DataFlow.DFClsProfileGroups
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Me.wcForm = New SCT.Admin.DataFlow.DFClsProfileGroups(Me)
        Else
            If SCT.Library.AdminSite.ClsSessionAdmin.SessionCurrentClsForm Is Nothing OrElse SCT.Library.AdminSite.ClsSessionAdmin.SessionCurrentClsForm.GetType().Name <> "DFClsProfileGroups" Then
                Me.wcForm = New SCT.Admin.DataFlow.DFClsProfileGroups(Me)
            Else
    ...
    Protected Sub GridView_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView.RowDataBound
        SCT.Admin.DataFlow.DFClsProfileGroups.ApplyGridRowAuthorizationRules(CType(sender, GridView), e.Row)
    End Sub
    ...
    Protected Sub ddlForms_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlForms.SelectedIndexChanged
        Me.wcForm.OnSelectedProfileFormChanged()
    End Sub
