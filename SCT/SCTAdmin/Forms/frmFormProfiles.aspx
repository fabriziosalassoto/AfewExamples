<%@ Page Language="VB" MasterPageFile="~/Forms/MasterPage.master" AutoEventWireup="false" CodeFile="frmFormProfiles.aspx.vb" Inherits="Forms_frmFormProfiles" title="IP Tracking Admin System - Profiles Permissions" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <asp:GridView ID="GridView" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        BorderWidth="1px" Caption="Form Profiles Permissions" CaptionAlign="Left" CellPadding="0" Font-Bold="True"
            ...
            <asp:TemplateField HeaderText="Form" SortExpression="Form">
                ...
                <ItemTemplate>
                    <asp:LinkButton ID="lnkForm" runat="server" CausesValidation="False" CommandArgument='<%# Eval("IDForm") %>'
                        Text='<%# Eval("Form") %>' OnClick="lnkForm_Click"></asp:LinkButton><asp:Label ID="lblForm" runat="server"
            ...
            <asp:TemplateField HeaderText="Edit" ShowHeader="False">
                ...
                <ItemTemplate>
                    <asp:ImageButton ID="cmdEdit" runat="server" AlternateText="Edit" CausesValidation="False"
                        CommandArgument='<%# Eval("IDForm") %>' CommandName='<%# Eval("IDProfile") %>'
    ...
    <table width="750">
        <tr>
            <td align="left" style="font-size: 9pt; font-family: Arial;">
                <asp:Label ID="lblForms" runat="server" Text="Filter by Form:"></asp:Label>&nbsp;<asp:DropDownList
                    ID="ddlForms" runat="server" AutoPostBack="True" Font-Names="Arial" Font-Size="9pt"
                    Width="200px">
                </asp:DropDownList><br />
            </td>
            <td align="right">
    ...
    <asp:Panel ID="pnlAddForm" runat="server" Height="50px" Width="750px" Visible="False">
        ...
        <table style="width: 750px" id="TABLE1">
            ...
            <tr>
                <td align="center" colspan="1" style="font-size: 9pt; font-family: Arial; width: 250px;">
                    <asp:Label ID="lblForm" runat="server" Text="Form:"></asp:Label>&nbsp;<asp:DropDownList
                        ID="ddlForm" runat="server" AutoPostBack="True" Width="200px">
                    </asp:DropDownList>
                ...
                <td colspan="1" style="font-size: 9pt; font-family: Arial; width: 215px;" align="center">
                    <asp:Label ID="lblProfile" runat="server" Text="Profile:"></asp:Label>
                    <asp:DropDownList ID="ddlProfile" runat="server" Font-Names="Arial"
                        Font-Size="9pt" Width="150px" AutoPostBack="True">
                    </asp:DropDownList>
                    <asp:CompareValidator ID="cvProfile" runat="server" ControlToValidate="ddlProfile"
                        ...
                        ValueToCompare="0" Display="Dynamic">*</asp:CompareValidator><asp:CustomValidator ID="cvValidateAssign" runat="server" ControlToValidate="ddlProfile"
                ...
                <td colspan="1" style="font-size: 9pt; font-family: Arial; border-bottom: silver 1px solid; width: 64px;">
