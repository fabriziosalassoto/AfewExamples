<%@ Page Language="VB" MasterPageFile="~/Forms/MasterPage.master" AutoEventWireup="false" CodeFile="frmAdvertiserToDos.aspx.vb" Inherits="Forms_frmAdvertiserToDos" title="IP Tracking Admin System - To Do" %>
    ...
    <table style="width: 800px">
        <tr>
            ...
            <td style="font-size: 10pt; vertical-align: top; font-family: Arial; text-align: right">
                ...
                <asp:RequiredFieldValidator ID="rqvContacts" runat="server" ControlToValidate="lstContacts"
                    ...
                    Font-Bold="True" Font-Size="Large" ForeColor="OrangeRed">*</asp:RequiredFieldValidator><asp:Label
                        ID="lblContacts" runat="server" Text="Contact:"></asp:Label><br />
                &nbsp;</td>
        ...
        <tr>
            <td style="font-size: 10pt; font-family: Arial; text-align: right">
                <asp:CustomValidator ID="csvStartDate" runat="server" Display="Dynamic" ErrorMessage="* Invalid Start Entered Date."
                    Font-Bold="True" Font-Names="Arial" Font-Size="Large" ForeColor="OrangeRed" SetFocusOnError="True">*</asp:CustomValidator>Start
                Entered Date:</td>
            <td contenteditable="true" rowspan="1" style="font-size: 10pt; vertical-align: top;
                font-family: Arial; text-align: left">
            ...
            <td style="font-size: 10pt; font-family: Arial; text-align: right">
                <asp:CustomValidator ID="csvEndDate" runat="server" Display="Dynamic" ErrorMessage="* Invalid End Entered Date."
                    Font-Bold="True" Font-Names="Arial" Font-Size="Large" ForeColor="OrangeRed" SetFocusOnError="True">*</asp:CustomValidator>End
                Entered Date:</td>
            <td style="font-size: 10pt; vertical-align: top; font-family: Arial; text-align: left">
                ...
                ,&nbsp;<asp:DropDownList ID="ddlEndYear" runat="server" Width="80px">
                </asp:DropDownList>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td align="right">
                <asp:Menu ID="cmdAddNew" runat="server" DynamicHorizontalOffset="2" Font-Names="Comic Sans MS"
                    ...
                    <DynamicMenuItemStyle HorizontalPadding="5px" VerticalPadding="2px" />
                    <Items>
                        <asp:MenuItem ImageUrl="~/Images/TODO16.BMP" Text=" Add New To Do" Value="AddNew"></asp:MenuItem>
                    </Items>
