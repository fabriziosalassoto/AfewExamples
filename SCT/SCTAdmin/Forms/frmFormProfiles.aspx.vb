...
Partial Class Forms_frmFormProfiles
    Inherits System.Web.UI.Page

    Private wcForm As SCT.Admin.DataFlow.DFClsFormProfiles
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Me.wcForm = New SCT.Admin.DataFlow.DFClsFormProfiles(Me)
        Else
            If SCT.Library.AdminSite.ClsSessionAdmin.SessionCurrentClsForm Is Nothing OrElse SCT.Library.AdminSite.ClsSessionAdmin.SessionCurrentClsForm.GetType().Name <> "DFClsFormProfiles" Then
                Me.wcForm = New SCT.Admin.DataFlow.DFClsFormProfiles(Me)
            Else
    ...
    Protected Sub GridView_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView.RowDataBound
        SCT.Admin.DataFlow.DFClsFormProfiles.ApplyGridRowAuthorizationRules(CType(sender, GridView), e.Row)
    End Sub
