...
<script runat="server">
    ...
    Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
        ...
        SCT.Library.AdminSite.ClsSessionAdmin.NewUserSessionValues()
    End Sub
    ...
    Protected Sub Application_AcquireRequestState(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            principal = SCT.Library.AdminSite.ClsSessionAdmin.GetSessionCslaPrincipal
        Catch
            principal = Nothing
        End Try
        ...
        If principal Is Nothing Then
            ...
            SCT.Library.Security.ClsSCTUserPrincipal.Logout()
        Else
