...
<Serializable()> Public Class ClsBinnacleFormEntryInfoList
    Inherits ReadOnlyListBase(Of ClsBinnacleFormEntryInfoList, ClsBinnacleFormEntryInfo)
...
#Region " Factory Methods "
    ...
    Public Shared Function NewBinnacleFormEntryInfoList() As ClsBinnacleFormEntryInfoList
        Return New ClsBinnacleFormEntryInfoList
    End Function

    Public Shared Function GetBinnacleFormEntryInfoList() As ClsBinnacleFormEntryInfoList
        Return DataPortal.Fetch(Of ClsBinnacleFormEntryInfoList)(New Criteria)
    End Function

    Public Shared Function GetBinnacleFormEntryInfoList(ByVal Log As Logs) As ClsBinnacleFormEntryInfoList
        Return DataPortal.Fetch(Of ClsBinnacleFormEntryInfoList)(New LogCriteria(Log))
    End Function

    Public Shared Function GetBinnacleFormEntryInfoList(ByVal Logs() As Logs) As ClsBinnacleFormEntryInfoList
        Return DataPortal.Fetch(Of ClsBinnacleFormEntryInfoList)(New LogCriteriaList(Logs))
    End Function

    Public Shared Function GetBinnacleFormEntryInfoList(ByVal log As Logs, ByVal idUser As SearchCriteria(Of Long), ByVal idForm As SearchCriteria(Of Long), ByVal idOperation As SearchCriteria(Of Long), ByVal fromDate As SearchCriteria(Of Date), ByVal toDate As SearchCriteria(Of Date), ByVal fromHour As SearchCriteria(Of Date), ByVal toHour As SearchCriteria(Of Date)) As ClsBinnacleFormEntryInfoList
        Return DataPortal.Fetch(Of ClsBinnacleFormEntryInfoList)(New FilteredCriteria(idUser, idForm, idOperation, fromDate, toDate, fromHour, toHour, log))
    End Function

    Public Shared Function GetBinnacleFormEntryInfoList(ByVal log() As Logs, ByVal idUser As SearchCriteriaList(Of Long), ByVal idForm As SearchCriteriaList(Of Long), ByVal idOperation As SearchCriteriaList(Of Long), ByVal fromDate As SearchCriteria(Of Date), ByVal toDate As SearchCriteria(Of Date), ByVal fromHour As SearchCriteria(Of Date), ByVal toHour As SearchCriteria(Of Date)) As ClsBinnacleFormEntryInfoList
        Return DataPortal.Fetch(Of ClsBinnacleFormEntryInfoList)(New FilteredCriteriaList(idUser, idForm, idOperation, fromDate, toDate, fromHour, toHour, log))
    End Function
...
#Region " Data Access "
    ...
    Private Sub Fetch(ByVal Logs() As Logs)
        Fetch(DAClsprgBinnacleFormEntry.Fetch(Logs))
    End Sub
    ...
    Private Sub Fetch(ByVal list As DAClsprgBinnacleFormEntry.Struct())
        ...
        For Each Struct As DAClsprgBinnacleFormEntry.Struct In list
            Me.Add(ClsBinnacleFormEntryInfo.GetBinnacleFormEntryInfo(Struct))
        Next
        IsReadOnly = True
