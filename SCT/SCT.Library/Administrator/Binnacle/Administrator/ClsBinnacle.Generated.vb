...
#Region " Business Methods "
        ...
        Public Property User() As ClsUserInfo
            Get
                CanReadProperty(True)
                Return Me.mUser
            End Get
            Set(ByVal value As ClsUserInfo)
        ...
        Public Sub AssignUser(ByVal UserId As Long)
            If UserId <> 0 Then
                If Me.mUser.ID <> UserId Then
                    Me.mUser = ClsUserInfo.GetUserInfo(UserId)
...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacle(ByVal Binnacle As DAClsprgAdministrativeBinnacle.Struct) As ClsBinnacle
            Return New ClsBinnacle(Binnacle)
        End Function

        Private Sub New(ByVal Binnacle As DAClsprgAdministrativeBinnacle.Struct)
            MarkAsChild()
            Fetch(Binnacle)
        End Sub
...
#Region " Root Area "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal criteria As UserCriteria)
            Dim List As DAClsprgAdministrativeBinnacle.Struct() = DAClsprgAdministrativeBinnacle.Fetch(New Parameter(Of Long)(criteria.IDUser, 0), New Parameter(Of Date)(criteria.BDate, 0))
            If List.Length > 0 Then
                Me.mStruct = List(0)
                Me.LoadObjectData()
            Else
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgAdministrativeBinnacle.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mUser})
                Me.mStruct = DAClsprgAdministrativeBinnacle.Update(Me.mStruct)
            End If
            Me.mBinnacleForms.Update(Me)
            Me.mBinnacleTables.Update(Me)
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            DAClsprgAdministrativeBinnacle.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal Binnacle As DAClsprgAdministrativeBinnacle.Struct)
            Me.mStruct = Binnacle
            Me.LoadObjectChildData()
            Me.MarkOld()
        End Sub
        ...
        Friend Sub DeleteSelf()
            ...
            DAClsprgAdministrativeBinnacle.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgAdministrativeBinnacle.Struct = New DAClsprgAdministrativeBinnacle.Struct

        Public Function GetTableStruct() As DAClsprgAdministrativeBinnacle.Struct
            Return Me.mStruct
        End Function
        ...
        Private Sub LoadObjectChildData()
            Me.LoadObjectData()
            Me.mBinnacleForms = ClsBinnacleFormList.GetChildBinnacleFormList(DAClsprgAdministrativeBinnacleForms.FetchByBinnacle(New Parameter(Of Long)(Me.mStruct.ID.Value, 0)))
            Me.mBinnacleTables = ClsBinnacleTableList.GetChildBinnacleTableList(DAClsprgAdministrativeBinnacleTables.FetchByBinnacle(New Parameter(Of Long)(Me.mStruct.ID.Value, 0)))
        End Sub
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgAdministrativeBinnacle.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
        ...
        <Serializable()> Private Class UserBinnacleExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgAdministrativeBinnacle.Fetch(New Parameter(Of Long)(Me.mIDUser, 0), New Parameter(Of Date)(Me.mBDate.Date, 0)).Length > 0)
            End Sub
