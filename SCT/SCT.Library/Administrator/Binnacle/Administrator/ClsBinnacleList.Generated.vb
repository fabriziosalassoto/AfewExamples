...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleList(ByVal list As DAClsprgAdministrativeBinnacle.Struct()) As ClsBinnacleList
        ...
        Private Sub New(ByVal list As DAClsprgAdministrativeBinnacle.Struct())
            MarkAsChild()
            Fetch(list)
        End Sub
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = DAClsprgAdministrativeBinnacle.FetchByUser(New Parameter(Of Long)(Me.mIDUser, 0)).Length > 0
            End Sub
