...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleFormField(ByVal BinnacleFormField As DAClsprgAdministrativeBinnacleFormFields.Struct) As ClsBinnacleFormField
            Return New ClsBinnacleFormField(BinnacleFormField)
        End Function

        Private Sub New(ByVal BinnacleFormField As DAClsprgAdministrativeBinnacleFormFields.Struct)
            MarkAsChild()
...
#Region " Root Area "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal criteria As Criteria)
            ...
            If List.Length > 0 Then
                ...
                Me.LoadObjectData()
            Else
                Throw New System.Security.SecurityException("Log Entry Detail Field doesn't exists")
            End If
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgAdministrativeBinnacleFormFields.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mBinnacleForm, Me.mField})
                Me.mStruct = DAClsprgAdministrativeBinnacleFormFields.Update(Me.mStruct)
            End If
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            DAClsprgAdministrativeBinnacleFormFields.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal BinnacleFormField As DAClsprgAdministrativeBinnacleFormFields.Struct)
        ...
        Friend Sub DeleteSelf()
            ...
            DAClsprgAdministrativeBinnacleFormFields.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgAdministrativeBinnacleFormFields.Struct = New DAClsprgAdministrativeBinnacleFormFields.Struct

        Public Function GetTableStruct() As DAClsprgAdministrativeBinnacleFormFields.Struct
            Return Me.mStruct
        End Function
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgAdministrativeBinnacleFormFields.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
