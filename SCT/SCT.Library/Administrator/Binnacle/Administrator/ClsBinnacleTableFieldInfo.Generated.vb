...
#Region " Authorization Rules "
        ...
        'AuthorizationRules.AllowRead("IDBinnacleTable", " ")
...
#Region " Factory Methods "
        ...
        Public Shared Function GetBinnacleTableFieldInfo(ByVal ID As Long) As ClsBinnacleTableFieldInfo
            Return DataPortal.Fetch(Of ClsBinnacleTableFieldInfo)(New Criteria(ID))
        End Function

        Public Shared Function GetBinnacleTableFieldInfo(ByVal Struct As DAClsprgAdministrativeBinnacleTableFields.Struct) As ClsBinnacleTableFieldInfo
...
#Region " Data Access "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal Struct As DAClsprgAdministrativeBinnacleTableFields.Struct)
        ...
        ''' <remarks></remarks>
        Private Sub LoadObjectData(ByVal Struct As DAClsprgAdministrativeBinnacleTableFields.Struct)
            With Struct
                Me.mID = .ID.Value
