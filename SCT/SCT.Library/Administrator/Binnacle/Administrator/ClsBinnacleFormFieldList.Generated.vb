...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleFormFieldList(ByVal list As DAClsprgAdministrativeBinnacleFormFields.Struct()) As ClsBinnacleFormFieldList
        ...
        Private Sub New(ByVal list As DAClsprgAdministrativeBinnacleFormFields.Struct())
            MarkAsChild()
            Fetch(list)
        End Sub
...
#Region " Common Area "
        ...
        Private Sub Fetch()
            Fetch(DAClsprgAdministrativeBinnacleFormFields.Fetch())
        End Sub

        Private Sub Fetch(ByVal idBinnacleForm As SearchCriteria(Of Long), ByVal idField As SearchCriteria(Of Long))
            Fetch(DAClsprgAdministrativeBinnacleFormFields.Fetch(New Parameter(Of Long)(idBinnacleForm.Value, idBinnacleForm.Priority), New Parameter(Of Long)(idField.Value, idField.Priority)))
        End Sub

        Private Sub Fetch(ByVal idBinnacleForm As SearchCriteriaList(Of Long), ByVal idField As SearchCriteriaList(Of Long))
            Fetch(DAClsprgAdministrativeBinnacleFormFields.Fetch(New ParameterList(Of Long)(idBinnacleForm.Values, idBinnacleForm.Priority), New ParameterList(Of Long)(idField.Values, idField.Priority)))
        End Sub

        Private Sub Fetch(ByVal list As DAClsprgAdministrativeBinnacleFormFields.Struct())
            Me.RaiseListChangedEvents = False
            For Each Struct As DAClsprgAdministrativeBinnacleFormFields.Struct In list
