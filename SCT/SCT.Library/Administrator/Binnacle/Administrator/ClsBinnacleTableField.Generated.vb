...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleTableField(ByVal BinnacleTableField As DAClsprgAdministrativeBinnacleTableFields.Struct) As ClsBinnacleTableField
            Return New ClsBinnacleTableField(BinnacleTableField)
        End Function

        Private Sub New(ByVal BinnacleTableField As DAClsprgAdministrativeBinnacleTableFields.Struct)
            MarkAsChild()
...
#Region " Root Area "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal criteria As Criteria)
            Dim List As DAClsprgAdministrativeBinnacleTableFields.Struct() = DAClsprgAdministrativeBinnacleTableFields.Fetch(New Parameter(Of Long)(criteria.ID, 0))
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgAdministrativeBinnacleTableFields.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mBinnacleTable})
                Me.mStruct = DAClsprgAdministrativeBinnacleTableFields.Update(Me.mStruct)
            End If
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            DAClsprgAdministrativeBinnacleTableFields.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal BinnacleTableField As DAClsprgAdministrativeBinnacleTableFields.Struct)
        ...
        Friend Sub DeleteSelf()
            ...
            DAClsprgAdministrativeBinnacleTableFields.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgAdministrativeBinnacleTableFields.Struct = New DAClsprgAdministrativeBinnacleTableFields.Struct

        Public Function GetTableStruct() As DAClsprgAdministrativeBinnacleTableFields.Struct
            Return Me.mStruct
        End Function
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgAdministrativeBinnacleTableFields.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
