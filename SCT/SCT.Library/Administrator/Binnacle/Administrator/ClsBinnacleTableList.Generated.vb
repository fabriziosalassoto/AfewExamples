...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleTableList(ByVal list As DAClsprgAdministrativeBinnacleTables.Struct()) As ClsBinnacleTableList
        ...
        Private Sub New(ByVal list As DAClsprgAdministrativeBinnacleTables.Struct())
            MarkAsChild()
            Fetch(list)
        End Sub
