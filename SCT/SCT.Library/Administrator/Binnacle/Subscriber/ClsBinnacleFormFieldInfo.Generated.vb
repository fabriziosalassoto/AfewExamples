...
#Region " Factory Methods "
        ...
        Public Shared Function GetBinnacleFormFieldInfo(ByVal ID As Long) As ClsBinnacleFormFieldInfo
            Return DataPortal.Fetch(Of ClsBinnacleFormFieldInfo)(New IDCriteria(ID))
        End Function

        Public Shared Function GetBinnacleFormFieldInfo(ByVal Struct As DAClsprgSubscriberBinnacleFormFields.Struct) As ClsBinnacleFormFieldInfo
...
#Region " Data Access "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal Struct As DAClsprgSubscriberBinnacleFormFields.Struct)
        ...
        ''' <remarks></remarks>
        Private Sub LoadObjectData(ByVal Struct As DAClsprgSubscriberBinnacleFormFields.Struct)
            With Struct
                Me.mID = .ID.Value
