...
#Region " Data Access "
        ...
        Private Sub Fetch()
            Dim list As DAClsprgSubscriberBinnacle.Struct() = DAClsprgSubscriberBinnacle.Fetch()

            RaiseListChangedEvents = False
            IsReadOnly = False
            For Each Struct As DAClsprgSubscriberBinnacle.Struct In list
        ...
        Private Sub Fetch(ByVal idUser As SearchCriteria(Of Long), ByVal fromDate As SearchCriteria(Of Date), ByVal toDate As SearchCriteria(Of Date))
            Dim list As DAClsprgSubscriberBinnacle.Struct() = DAClsprgSubscriberBinnacle.Fetch(New Parameter(Of Long)(idUser.Value, idUser.Priority), New Parameter(Of Date)(fromDate.Value, fromDate.Priority), New Parameter(Of Date)(toDate.Value, toDate.Priority))
        ...
        Private Sub Fetch(ByVal idUser As SearchCriteriaList(Of Long), ByVal fromDate As SearchCriteria(Of Date), ByVal toDate As SearchCriteria(Of Date))
            Dim list As DAClsprgSubscriberBinnacle.Struct() = DAClsprgSubscriberBinnacle.Fetch(New ParameterList(Of Long)(idUser.Values, idUser.Priority), New Parameter(Of Date)(fromDate.Value, fromDate.Priority), New Parameter(Of Date)(toDate.Value, toDate.Priority))
