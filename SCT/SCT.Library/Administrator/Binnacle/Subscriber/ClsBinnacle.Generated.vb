...
#Region " Root Methods "
        ...
        Public Shared Sub DeleteSubscriberBinnacle(ByVal ID As Long)
...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacle(ByVal Binnacle As DAClsprgSubscriberBinnacle.Struct) As ClsBinnacle
            Return New ClsBinnacle(Binnacle)
        End Function

        Private Sub New(ByVal Binnacle As DAClsprgSubscriberBinnacle.Struct)
            MarkAsChild()
            Fetch(Binnacle)
        End Sub
...
#Region " Root Area "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal criteria As UserCriteria)
            Dim List As DAClsprgSubscriberBinnacle.Struct() = DAClsprgSubscriberBinnacle.Fetch(New Parameter(Of Long)(criteria.IDUser, 0), New Parameter(Of Date)(criteria.BDate, 0))
            If List.Length > 0 Then
                Me.mStruct = List(0)
                Me.LoadObjectData()
            Else
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgSubscriberBinnacle.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mUser})
                Me.mStruct = DAClsprgSubscriberBinnacle.Update(Me.mStruct)
            End If
            Me.mBinnacleForms.Update(Me)
            Me.mBinnacleTables.Update(Me)
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            ...
            Me.mBinnacleForms.Update(Me)
            Me.mBinnacleTables.Update(Me)
            DAClsprgSubscriberBinnacle.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal Binnacle As DAClsprgSubscriberBinnacle.Struct)
            Me.mStruct = Binnacle
            Me.LoadObjectData()
            MarkOld()
        End Sub
        ...
        Friend Sub DeleteSelf()
            ...
            Me.mBinnacleForms.Update(Me)
            Me.mBinnacleTables.Update(Me)
            DAClsprgSubscriberBinnacle.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgSubscriberBinnacle.Struct = New DAClsprgSubscriberBinnacle.Struct

        Public Function GetTableStruct() As DAClsprgSubscriberBinnacle.Struct
            Return Me.mStruct
        End Function
        ...
        Private Sub LoadObjectChildData()
            Me.LoadObjectData()
            Me.mBinnacleForms = ClsBinnacleFormList.GetChildBinnacleFormList(DAClsprgSubscriberBinnacleForms.FetchByBinnacle(New Parameter(Of Long)(Me.mStruct.ID.Value, 0)))
            Me.mBinnacleTables = ClsBinnacleTableList.GetChildBinnacleTableList(DAClsprgSubscriberBinnacleTables.FetchByBinnacle(New Parameter(Of Long)(Me.mStruct.ID.Value, 0)))
        End Sub
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgSubscriberBinnacle.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
        ...
        <Serializable()> Private Class UserBinnacleExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgSubscriberBinnacle.Fetch(New Parameter(Of Long)(Me.mIDUser, 0), New Parameter(Of Date)(Me.mBDate.Date, 0)).Length > 0)
            End Sub
