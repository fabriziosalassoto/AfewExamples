...
#Region " Business Methods "
        ...
        Public Overloads Sub AddNewItem(ByVal form As ClsForm, ByVal operation As ClsOperation, ByVal hour As Date, ByVal ParamArray formFieldsData() As Object)
...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleFormList(ByVal list As DAClsprgSubscriberBinnacleForms.Struct()) As ClsBinnacleFormList
        ...
        Private Sub New(ByVal list As DAClsprgSubscriberBinnacleForms.Struct())
            MarkAsChild()
            Fetch(list)
        End Sub
...
#Region " Common Area "
        ...
        Private Sub Fetch()
            Fetch(DAClsprgSubscriberBinnacleForms.Fetch())
        End Sub
        ...
        Private Sub Fetch(ByVal idBinnacle As SearchCriteria(Of Long), ByVal idForm As SearchCriteria(Of Long), ByVal idOperation As SearchCriteria(Of Long), ByVal fromHour As SearchCriteria(Of Date), ByVal toHour As SearchCriteria(Of Date))
            Fetch(DAClsprgSubscriberBinnacleForms.Fetch(New Parameter(Of Long)(idBinnacle.Value, idBinnacle.Priority), New Parameter(Of Long)(idForm.Value, idForm.Priority), New Parameter(Of Long)(idOperation.Value, idOperation.Priority), New Parameter(Of Date)(fromHour.Value, fromHour.Priority), New Parameter(Of Date)(toHour.Value, toHour.Priority)))
        End Sub
        ...
        Private Sub Fetch(ByVal idBinnacle As SearchCriteriaList(Of Long), ByVal idForm As SearchCriteriaList(Of Long), ByVal idOperation As SearchCriteriaList(Of Long), ByVal fromHour As SearchCriteria(Of Date), ByVal toHour As SearchCriteria(Of Date))
            Fetch(DAClsprgSubscriberBinnacleForms.Fetch(New ParameterList(Of Long)(idBinnacle.Values, idBinnacle.Priority), New ParameterList(Of Long)(idForm.Values, idForm.Priority), New ParameterList(Of Long)(idOperation.Values, idOperation.Priority), New Parameter(Of Date)(fromHour.Value, fromHour.Priority), New Parameter(Of Date)(toHour.Value, toHour.Priority)))
        End Sub

        Private Sub Fetch(ByVal list As DAClsprgSubscriberBinnacleForms.Struct())
