...
#Region " Factory Methods "
        ...
        Public Shared Function GetBinnacleFormInfo(ByVal Struct As DAClsprgSubscriberBinnacleForms.Struct) As ClsBinnacleFormInfo
...
#Region " Data Access "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal Struct As DAClsprgSubscriberBinnacleForms.Struct)
        ...
        ''' <remarks></remarks>
        Private Sub LoadObjectData(ByVal Struct As DAClsprgSubscriberBinnacleForms.Struct)
            With Struct
                Me.mID = .ID.Value
