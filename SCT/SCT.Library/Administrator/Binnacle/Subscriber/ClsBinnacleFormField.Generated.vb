...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleFormField(ByVal BinnacleFormField As DAClsprgSubscriberBinnacleFormFields.Struct) As ClsBinnacleFormField
            Return New ClsBinnacleFormField(BinnacleFormField)
        End Function

        Private Sub New(ByVal BinnacleFormField As DAClsprgSubscriberBinnacleFormFields.Struct)
            MarkAsChild()
...
#Region " Root Area "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal criteria As Criteria)
            Dim List As DAClsprgSubscriberBinnacleFormFields.Struct() = DAClsprgSubscriberBinnacleFormFields.Fetch(New Parameter(Of Long)(criteria.ID, 0))
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgSubscriberBinnacleFormFields.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mBinnacleForm, Me.mField})
                Me.mStruct = DAClsprgSubscriberBinnacleFormFields.Update(Me.mStruct)
            End If
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            DAClsprgSubscriberBinnacleFormFields.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal BinnacleFormField As DAClsprgSubscriberBinnacleFormFields.Struct)
        ...
        Friend Sub DeleteSelf()
            ...
            DAClsprgSubscriberBinnacleFormFields.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgSubscriberBinnacleFormFields.Struct = New DAClsprgSubscriberBinnacleFormFields.Struct

        Public Function GetTableStruct() As DAClsprgSubscriberBinnacleFormFields.Struct
            Return Me.mStruct
        End Function
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgSubscriberBinnacleFormFields.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
