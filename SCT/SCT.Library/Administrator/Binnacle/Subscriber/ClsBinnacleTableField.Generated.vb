...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleTableField(ByVal BinnacleTableField As DAClsprgSubscriberBinnacleTableFields.Struct) As ClsBinnacleTableField
            Return New ClsBinnacleTableField(BinnacleTableField)
        End Function

        Private Sub New(ByVal BinnacleTableField As DAClsprgSubscriberBinnacleTableFields.Struct)
            MarkAsChild()
...
#Region " Root Area "
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgSubscriberBinnacleTableFields.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mBinnacleTable})
                Me.mStruct = DAClsprgSubscriberBinnacleTableFields.Update(Me.mStruct)
            End If
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            DAClsprgSubscriberBinnacleTableFields.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal BinnacleTableField As DAClsprgSubscriberBinnacleTableFields.Struct)
        ...
        Friend Sub DeleteSelf()
            ...
            DAClsprgSubscriberBinnacleTableFields.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgSubscriberBinnacleTableFields.Struct = New DAClsprgSubscriberBinnacleTableFields.Struct

        Public Function GetTableStruct() As DAClsprgSubscriberBinnacleTableFields.Struct
            Return Me.mStruct
        End Function
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgSubscriberBinnacleTableFields.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
