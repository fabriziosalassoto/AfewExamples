...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleList(ByVal list As DAClsprgSubscriberBinnacle.Struct()) As ClsBinnacleList
        ...
        Private Sub New(ByVal list As DAClsprgSubscriberBinnacle.Struct())
            MarkAsChild()
            Fetch(list)
        End Sub
...
#Region " Common Area "
        ...
        Private Sub Fetch()
            Fetch(DAClsprgSubscriberBinnacle.Fetch())
        End Sub
        ...
        Private Sub Fetch(ByVal list As DAClsprgSubscriberBinnacle.Struct())
