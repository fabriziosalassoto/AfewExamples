...
#Region " Business Methods "
        ...
        Public Property BHour() As DateTime
            Get
                CanReadProperty(True)
                Return Me.mBHour
            End Get
...
#Region " Authorization Rules "
        ...
        '    AuthorizationRules.AllowWrite("BinnacleTableFields", New String() {" ", " "})
        'End Sub
...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleTable(ByVal BinnacleTable As DAClsprgSubscriberBinnacleTables.Struct) As ClsBinnacleTable
            Return New ClsBinnacleTable(BinnacleTable)
        End Function

        Private Sub New(ByVal BinnacleTable As DAClsprgSubscriberBinnacleTables.Struct)
            MarkAsChild()
            Fetch(BinnacleTable)
        End Sub
...
#Region " Root Area "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal criteria As Criteria)
            Dim List As DAClsprgSubscriberBinnacleTables.Struct() = DAClsprgSubscriberBinnacleTables.Fetch(New Parameter(Of Long)(criteria.ID, 0))
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgSubscriberBinnacleTables.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mBinnacle, Me.mOperation})
                Me.mStruct = DAClsprgSubscriberBinnacleTables.Update(Me.mStruct)
            End If
            Me.mBinnacleTableFields.Update(Me)
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            ...
            Me.mBinnacleTableFields.Update(Me)
            DAClsprgSubscriberBinnacleTables.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal BinnacleTable As DAClsprgSubscriberBinnacleTables.Struct)
        ...
        Friend Sub DeleteSelf()
            ...
            Me.mBinnacleTableFields.Clear()
            Me.mBinnacleTableFields.Update(Me)
            DAClsprgSubscriberBinnacleTables.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgSubscriberBinnacleTables.Struct = New DAClsprgSubscriberBinnacleTables.Struct

        Public Function GetTableStruct() As DAClsprgSubscriberBinnacleTables.Struct
            Return Me.mStruct
        End Function
        ...
        Private Sub LoadObjectData()
            With Me.mStruct
                ...
                Me.mBinnacleTableFields = ClsBinnacleTableFieldList.GetChildBinnacleTableFieldList(DAClsprgSubscriberBinnacleTableFields.FetchByBinnacleTable(New Parameter(Of Long)(.ID.Value, 0)))
            End With
        End Sub
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgSubscriberBinnacleTables.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
