...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleTableFieldList(ByVal list As DAClsprgSubscriberBinnacleTableFields.Struct()) As ClsBinnacleTableFieldList
        ...
        Private Sub New(ByVal list As DAClsprgSubscriberBinnacleTableFields.Struct())
            MarkAsChild()
            Fetch(list)
        End Sub
...
#Region " Common Area "
        ...
        Private Sub Fetch()
            Fetch(DAClsprgSubscriberBinnacleTableFields.Fetch())
        End Sub

        Private Sub Fetch(ByVal idBinnacleTable As SearchCriteria(Of Long), ByVal fieldName As SearchCriteria(Of String))
            Fetch(DAClsprgSubscriberBinnacleTableFields.Fetch(New Parameter(Of Long)(idBinnacleTable.Value, idBinnacleTable.Priority), New Parameter(Of String)(fieldName.Value, fieldName.Priority)))
        End Sub

        Private Sub Fetch(ByVal idBinnacleTable As SearchCriteriaList(Of Long), ByVal fieldName As SearchCriteriaList(Of String))
            Fetch(DAClsprgSubscriberBinnacleTableFields.Fetch(New ParameterList(Of Long)(idBinnacleTable.Values, idBinnacleTable.Priority), New ParameterList(Of String)(fieldName.Values, fieldName.Priority)))
        End Sub

        Private Sub Fetch(ByVal list As DAClsprgSubscriberBinnacleTableFields.Struct())
