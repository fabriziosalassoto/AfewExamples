...
#Region " Authorization Rules "
        ...
        '    AuthorizationRules.AllowWrite("Binnacle", New String() {" ", " "})
        '    AuthorizationRules.AllowWrite("Form", New String() {" ", " "})
        '    AuthorizationRules.AllowWrite("Operation", New String() {" ", " "})
        '    AuthorizationRules.AllowWrite("BHour", New String() {" ", " "})
        '    AuthorizationRules.AllowWrite("BinnacleFormFields", New String() {" ", " "})
        'End Sub
...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleForm(ByVal BinnacleForm As DAClsprgSubscriberBinnacleForms.Struct) As ClsBinnacleForm
            Return New ClsBinnacleForm(BinnacleForm)
        End Function

        Private Sub New(ByVal BinnacleForm As DAClsprgSubscriberBinnacleForms.Struct)
            MarkAsChild()
            Fetch(BinnacleForm)
        End Sub
...
#Region " Root Area "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal criteria As Criteria)
            Dim List As DAClsprgSubscriberBinnacleForms.Struct() = DAClsprgSubscriberBinnacleForms.Fetch(New Parameter(Of Long)(criteria.ID, 0))
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgSubscriberBinnacleForms.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mBinnacle, Me.mForm, Me.mOperation})
                Me.mStruct = DAClsprgSubscriberBinnacleForms.Update(Me.mStruct)
            End If
            Me.mBinnacleFormFields.Update(Me)
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            Me.mBinnacleFormFields.Clear()
            Me.mBinnacleFormFields.Update(Me)
            DAClsprgSubscriberBinnacleForms.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal BinnacleForm As DAClsprgSubscriberBinnacleForms.Struct)
        ...
        Friend Sub DeleteSelf()
            ...
            Me.mBinnacleFormFields.Clear()
            Me.mBinnacleFormFields.Update(Me)
            DAClsprgSubscriberBinnacleForms.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgSubscriberBinnacleForms.Struct = New DAClsprgSubscriberBinnacleForms.Struct

        Public Function GetTableStruct() As DAClsprgSubscriberBinnacleForms.Struct
            Return Me.mStruct
        End Function
        ...
        Private Sub LoadObjectData()
            With Me.mStruct
                ...
                Me.mBinnacleFormFields = ClsBinnacleFormFieldList.GetChildBinnacleFormFieldList(DAClsprgSubscriberBinnacleFormFields.FetchByBinnacleForm(New Parameter(Of Long)(.ID.Value, 0)))
            End With
        End Sub
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgSubscriberBinnacleForms.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
