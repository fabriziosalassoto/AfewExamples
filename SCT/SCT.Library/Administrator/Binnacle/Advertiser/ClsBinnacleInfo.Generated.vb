...
#Region " Factory Methods "
        ...
        Public Shared Function GetBinnacleInfo(ByVal Struct As DAClsprgAdvertiserBinnacle.Struct) As ClsBinnacleInfo
...
#Region " Data Access "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal Struct As DAClsprgAdvertiserBinnacle.Struct)
        ...
        ''' <remarks></remarks>
        Private Sub LoadObjectData(ByVal Struct As DAClsprgAdvertiserBinnacle.Struct)
            With Struct
                Me.mID = .ID.Value
