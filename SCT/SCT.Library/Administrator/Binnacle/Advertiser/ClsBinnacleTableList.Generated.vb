...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleTableList(ByVal list As DAClsprgAdvertiserBinnacleTables.Struct()) As ClsBinnacleTableList
        ...
        Private Sub New(ByVal list As DAClsprgAdvertiserBinnacleTables.Struct())
            MarkAsChild()
            Fetch(list)
        End Sub
...
#Region " Common Area "
        ...
        Private Sub Fetch()
            Fetch(DAClsprgAdvertiserBinnacleTables.Fetch())
        End Sub
        ...
        Private Sub Fetch(ByVal idBinnacle As SearchCriteria(Of Long), ByVal idOperation As SearchCriteria(Of Long), ByVal tableName As SearchCriteria(Of String), ByVal fromHour As SearchCriteria(Of Date), ByVal toHour As SearchCriteria(Of Date))
            Fetch(DAClsprgAdvertiserBinnacleTables.Fetch(New Parameter(Of Long)(idBinnacle.Value, idBinnacle.Priority), New Parameter(Of String)(tableName.Value, tableName.Priority), New Parameter(Of Long)(idOperation.Value, idOperation.Priority), New Parameter(Of Date)(fromHour.Value, fromHour.Priority), New Parameter(Of Date)(toHour.Value, toHour.Priority)))
        End Sub
        ...
        Private Sub Fetch(ByVal idBinnacle As SearchCriteriaList(Of Long), ByVal idOperation As SearchCriteriaList(Of Long), ByVal tableName As SearchCriteriaList(Of String), ByVal fromHour As SearchCriteria(Of Date), ByVal toHour As SearchCriteria(Of Date))
            Fetch(DAClsprgAdvertiserBinnacleTables.Fetch(New ParameterList(Of Long)(idBinnacle.Values, idBinnacle.Priority), New ParameterList(Of String)(tableName.Values, tableName.Priority), New ParameterList(Of Long)(idOperation.Values, idOperation.Priority), New Parameter(Of Date)(fromHour.Value, fromHour.Priority), New Parameter(Of Date)(toHour.Value, toHour.Priority)))
        End Sub

        Private Sub Fetch(ByVal list As DAClsprgAdvertiserBinnacleTables.Struct())
            Me.RaiseListChangedEvents = False
            For Each Struct As DAClsprgAdvertiserBinnacleTables.Struct In list
