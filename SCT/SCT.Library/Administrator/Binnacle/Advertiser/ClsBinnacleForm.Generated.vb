...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleForm(ByVal BinnacleForm As DAClsprgAdvertiserBinnacleForms.Struct) As ClsBinnacleForm
            Return New ClsBinnacleForm(BinnacleForm)
        End Function

        Private Sub New(ByVal BinnacleForm As DAClsprgAdvertiserBinnacleForms.Struct)
            MarkAsChild()
            Fetch(BinnacleForm)
        End Sub
...
#Region " Root Area "
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgAdvertiserBinnacleForms.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mBinnacle, Me.mForm, Me.mOperation})
                Me.mStruct = DAClsprgAdvertiserBinnacleForms.Update(Me.mStruct)
            End If
            Me.mBinnacleFormFields.Update(Me)
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            ...
            Me.mBinnacleFormFields.Update(Me)
            DAClsprgAdvertiserBinnacleForms.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal BinnacleForm As DAClsprgAdvertiserBinnacleForms.Struct)
        ...
        Friend Sub DeleteSelf()
            ...
            Me.mBinnacleFormFields.Clear()
            Me.mBinnacleFormFields.Update(Me)
            DAClsprgAdvertiserBinnacleForms.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgAdvertiserBinnacleForms.Struct = New DAClsprgAdvertiserBinnacleForms.Struct

        Public Function GetTableStruct() As DAClsprgAdvertiserBinnacleForms.Struct
            Return Me.mStruct
        End Function
        ...
        Private Sub LoadObjectData()
            With Me.mStruct
                ...
                Me.mBinnacleFormFields = ClsBinnacleFormFieldList.GetChildBinnacleFormFieldList(DAClsprgAdvertiserBinnacleFormFields.FetchByBinnacleForm(New Parameter(Of Long)(.ID.Value, 0)))
            End With
        End Sub
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgAdvertiserBinnacleForms.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
