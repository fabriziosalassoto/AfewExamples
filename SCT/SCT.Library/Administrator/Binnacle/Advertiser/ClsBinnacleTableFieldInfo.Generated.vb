...
#Region " Factory Methods "
        ...
        Public Shared Function GetBinnacleTableFieldInfo(ByVal Struct As DAClsprgAdvertiserBinnacleTableFields.Struct) As ClsBinnacleTableFieldInfo
...
#Region " Data Access "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal Struct As DAClsprgAdvertiserBinnacleTableFields.Struct)
        ...
        ''' <remarks></remarks>
        Private Sub LoadObjectData(ByVal Struct As DAClsprgAdvertiserBinnacleTableFields.Struct)
            With Struct
                Me.mID = .ID.Value
