...
#Region " Data Access "
        ...
        Private Sub Fetch()
            Dim list As DAClsprgAdvertiserBinnacleFormFields.Struct() = DAClsprgAdvertiserBinnacleFormFields.Fetch()
        ...
        Private Sub Fetch(ByVal IDBinnacleForm As SearchCriteria(Of Long), ByVal IDField As SearchCriteria(Of Long))
            Dim list As DAClsprgAdvertiserBinnacleFormFields.Struct() = DAClsprgAdvertiserBinnacleFormFields.Fetch(New Parameter(Of Long)(IDBinnacleForm.Value, IDBinnacleForm.Priority), New Parameter(Of Long)(IDField.Value, IDField.Priority))
        ...
        Private Sub Fetch(ByVal idBinnacleForm As SearchCriteriaList(Of Long), ByVal idField As SearchCriteriaList(Of Long))
            Dim list As DAClsprgAdvertiserBinnacleFormFields.Struct() = DAClsprgAdvertiserBinnacleFormFields.Fetch(New ParameterList(Of Long)(idBinnacleForm.Values, idBinnacleForm.Priority), New ParameterList(Of Long)(idField.Values, idField.Priority))
