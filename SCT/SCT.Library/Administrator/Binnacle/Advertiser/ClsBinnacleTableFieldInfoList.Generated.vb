...
#Region " Data Access "
        ...
        Private Sub Fetch()
            Dim list As DAClsprgAdvertiserBinnacleTableFields.Struct() = DAClsprgAdvertiserBinnacleTableFields.Fetch()
        ...
        Private Sub Fetch(ByVal idBinnacleTable As SearchCriteria(Of Long), ByVal fieldName As SearchCriteria(Of String))
            Dim list As DAClsprgAdvertiserBinnacleTableFields.Struct() = DAClsprgAdvertiserBinnacleTableFields.Fetch(New Parameter(Of Long)(idBinnacleTable.Value, idBinnacleTable.Priority), New Parameter(Of String)(fieldName.Value, fieldName.Priority))
        ...
        Private Sub Fetch(ByVal idBinnacleTable As SearchCriteriaList(Of Long), ByVal fieldName As SearchCriteriaList(Of String))
            Dim list As DAClsprgAdvertiserBinnacleTableFields.Struct() = DAClsprgAdvertiserBinnacleTableFields.Fetch(New ParameterList(Of Long)(idBinnacleTable.Values, idBinnacleTable.Priority), New ParameterList(Of String)(fieldName.Values, fieldName.Priority))
