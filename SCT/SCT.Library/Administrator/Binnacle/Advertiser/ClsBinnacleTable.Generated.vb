...
#Region " Child Methods "
        ...
        Friend Shared Function GetChildBinnacleTable(ByVal AdvertiserBinnacleTable As DAClsprgAdvertiserBinnacleTables.Struct) As ClsBinnacleTable
            Return New ClsBinnacleTable(AdvertiserBinnacleTable)
        End Function

        Private Sub New(ByVal BinnacleTable As DAClsprgAdvertiserBinnacleTables.Struct)
            MarkAsChild()
            Fetch(BinnacleTable)
        End Sub
...
#Region " Root Area "
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Insert()
            ...
            Me.mStruct = DAClsprgAdvertiserBinnacleTables.Insert(Me.mStruct)
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Protected Overrides Sub DataPortal_Update()
            If MyBase.IsDirty Then
                Me.LoadTableStruct(New Object() {Me.mBinnacle, Me.mOperation})
                Me.mStruct = DAClsprgAdvertiserBinnacleTables.Update(Me.mStruct)
            End If
            Me.mBinnacleTableFields.Update(Me)
        End Sub
        ...
        <Transactional(TransactionalTypes.TransactionScope)> Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            ...
            Me.mBinnacleTableFields.Update(Me)
            DAClsprgAdvertiserBinnacleTables.Delete(criteria.ID)
        End Sub
...
#Region " Child Area "
        ...
        Private Sub Fetch(ByVal BinnacleTable As DAClsprgAdvertiserBinnacleTables.Struct)
        ...
        Friend Sub DeleteSelf()
            ...
            Me.mBinnacleTableFields.Clear()
            Me.mBinnacleTableFields.Update(Me)
            DAClsprgAdvertiserBinnacleTables.Delete(Me.mID)
            MarkNew()
        End Sub
...
#Region " Common Area "
        ...
        Private mStruct As DAClsprgAdvertiserBinnacleTables.Struct = New DAClsprgAdvertiserBinnacleTables.Struct

        Public Function GetTableStruct() As DAClsprgAdvertiserBinnacleTables.Struct
            Return Me.mStruct
        End Function
        ...
        Private Sub LoadObjectData()
            With Me.mStruct
                ...
                Me.mBinnacleTableFields = ClsBinnacleTableFieldList.GetChildBinnacleTableFieldList(DAClsprgAdvertiserBinnacleTableFields.FetchByBinnacleTable(New Parameter(Of Long)(.ID.Value, 0)))
            End With
        End Sub
...
#Region " Exists "
        ...
        <Serializable()> Private Class ExistsCommand
            ...
            Protected Overrides Sub DataPortal_Execute()
                Me.mExists = (DAClsprgAdvertiserBinnacleTables.Fetch(New Parameter(Of Long)(Me.mID, 0)).Length > 0)
            End Sub
