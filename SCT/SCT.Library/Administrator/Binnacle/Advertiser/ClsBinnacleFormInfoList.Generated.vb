...
#Region " Data Access "
        ...
        Private Sub Fetch()
            Dim list As DAClsprgAdvertiserBinnacleForms.Struct() = DAClsprgAdvertiserBinnacleForms.Fetch()
        ...
        Private Sub Fetch(ByVal idBinnacle As SearchCriteria(Of Long), ByVal idForm As SearchCriteria(Of Long), ByVal idOperation As SearchCriteria(Of Long), ByVal fromHour As SearchCriteria(Of Date), ByVal toHour As SearchCriteria(Of Date))
            Dim list As DAClsprgAdvertiserBinnacleForms.Struct() = DAClsprgAdvertiserBinnacleForms.Fetch(New Parameter(Of Long)(idBinnacle.Value, idBinnacle.Priority), New Parameter(Of Long)(idForm.Value, idForm.Priority), New Parameter(Of Long)(idOperation.Value, idOperation.Priority), New Parameter(Of Date)(fromHour.Value, fromHour.Priority), New Parameter(Of Date)(toHour.Value, toHour.Priority))
        ...
        Private Sub Fetch(ByVal idBinnacle As SearchCriteriaList(Of Long), ByVal idForm As SearchCriteriaList(Of Long), ByVal idOperation As SearchCriteriaList(Of Long), ByVal fromHour As SearchCriteria(Of Date), ByVal toHour As SearchCriteria(Of Date))
            Dim list As DAClsprgAdvertiserBinnacleForms.Struct() = DAClsprgAdvertiserBinnacleForms.Fetch(New ParameterList(Of Long)(idBinnacle.Values, idBinnacle.Priority), New ParameterList(Of Long)(idForm.Values, idForm.Priority), New ParameterList(Of Long)(idOperation.Values, idOperation.Priority), New Parameter(Of Date)(fromHour.Value, fromHour.Priority), New Parameter(Of Date)(toHour.Value, toHour.Priority))
