...
#Region " Factory Methods "
        ...
        Public Shared Function GetBinnacleFormFieldInfo(ByVal Struct As DAClsprgAdvertiserBinnacleFormFields.Struct) As ClsBinnacleFormFieldInfo
...
#Region " Data Access "
        ...
        Private Overloads Sub DataPortal_Fetch(ByVal Struct As DAClsprgAdvertiserBinnacleFormFields.Struct)
        ...
        ''' <remarks></remarks>
        Private Sub LoadObjectData(ByVal Struct As DAClsprgAdvertiserBinnacleFormFields.Struct)
            With Struct
                Me.mID = .ID.Value
