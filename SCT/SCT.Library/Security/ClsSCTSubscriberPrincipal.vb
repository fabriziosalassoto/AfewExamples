...
Namespace Security
    <Serializable()> Public Class ClsSCTSubscriberPrincipal
        ...
        Public Shared Function Login(ByVal username As String, ByVal password As String) As Boolean
            ...
            If identity.IsAuthenticated Then
                Csla.ApplicationContext.User = New ClsSCTSubscriberPrincipal(identity)
            End If
            Return identity.IsAuthenticated
        End Function

        Public Shared Sub Logout()
            Csla.ApplicationContext.User = New ClsSCTSubscriberPrincipal(ClsSCTSubcriberIdentity.UnauthenticatedIdentity)
        End Sub
