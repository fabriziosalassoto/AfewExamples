...
<Serializable()> Public Class ProfileGroupNewData
    ...
    Public Property Form() As ProfileFormNewData
        Get
            Return Me.mForm
        End Get
        Set(ByVal value As ProfileFormNewData)
            Me.mForm = value
        End Set
    End Property
