...
Public Class DFClsAdvertiserStateOfAccount

#Region " Private Fields "

    Private mForm As Object
    Private mData As AdStateOfAccountData
...
#Region " Authorization Rules "
    ...
    Public Shared Function CanSelect() As Boolean
        If ClsSessionAdmin.ContainsUserProfileInForm("frmAdvertiserStateOfAccount") Then
            Return ClsSessionAdmin.CanSelectInForm("frmAdvertiserStateOfAccount")
        Else
...
#Region " Properties And Methods "
    ...
    Public Sub New(ByRef form As Object)
        Me.mForm = form
        Me.mForm.Session("ValuePath") = "frmAdvertisers/frmAdvertiserStateOfAccount"
    ...
    Public Sub ApplyPageAuthorizationRules()
        If (Not ClsSessionAdmin.IsValidForm("frmAdvertiserStateOfAccount", "grdTransactions.ID")) OrElse (Not DFClsAdvertiserTransactions.CanSelect()) Then Me.mForm.Response.Redirect("~/Forms/frmMain.aspx")
    End Sub
    ...
    Private Function GetDataSources() As DataTable
        ...
        For Each transaction As AdTransactionData In Me.mData.TransactionInvoices.TransactionInvoices
        ...
        For Each transaction As AdTransactionData In Me.mData.TransactionReceipts.TransactionReceipts
    ...
    Public Sub SubmitQuery()
        ...
        Me.mData = Me.GetDataList(Me.mIDsAdvertisers, Me.mIDsProjects, Me.mStartDate, Me.mEndDate)
...
#Region " Data Methods "
    ...
    Private Sub PopulateDataList(ByVal SortExpression As String, ByVal SortDirection As String, ByVal PageIndex As Integer)
        ...
        Me.LoadGridView(Me.mForm.FindControls("grdTransactions"))
    End Sub
    ...
    Private Sub PopulateData()
        Me.mForm.FindControls("tblBalance").Rows(1).Cells(0).Text = Me.mData.StartBalance.ToString("#,###,##0.00")
        Me.mForm.FindControls("tblBalance").Rows(1).Cells(1).Text = Me.mData.TransactionInvoices.TransactionInvoicesTotal.ToString("#,###,##0.00")
        Me.mForm.FindControls("tblBalance").Rows(1).Cells(2).Text = Me.mData.TransactionReceipts.TransactionReceiptsTotal.ToString("#,###,##0.00")
        Me.mForm.FindControls("tblBalance").Rows(1).Cells(3).Text = Me.mData.EndBalance.ToString("#,###,##0.00")
    End Sub

    Private Function GetDataList(ByVal idAdvertisers As Long(), ByVal idProjects As Long(), ByVal startDate As Date, ByVal endDate As Date) As AdStateOfAccountData
        Try
            Return ClsSessionAdmin.GetAdStateOfAccount(idAdvertisers, idProjects, startDate, endDate)
        Catch SysEx As Exception
            Me.mForm.FindControls("MsgBox").ShowMessage("Error reading: " & SysEx.Message)
            Return New AdStateOfAccountData
        End Try
    End Function
