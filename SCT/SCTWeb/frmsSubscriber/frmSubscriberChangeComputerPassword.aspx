<%@ Page Language="VB" MasterPageFile="~/frmsSubscriber/MasterPage.master" AutoEventWireup="false" CodeFile="frmSubscriberChangeComputerPassword.aspx.vb" Inherits="frmsSubscriber_frmSubscriberChangeComputerPassword" title="IP Tracking System - Change Password" %>
            ...
            <tr>
                <td style="height: 570px; font-size: 9pt; font-family: Arial;" align="center" valign="top">
                    ...
                    <table style="width: 600px;" id="TABLE1">
                        <tr>
                            <td align="left">
                    <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Size="14pt" Text="Change Computer Password" Font-Names="Comic Sans MS"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>*Required fields. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                ...
                                <table style="width: 500px">
                                    <tr>
                                        <td align="right" style="font-size: 9pt; width: 250px; font-family: Arial">
                                            Computer Serial Number:&nbsp;</td>
                                        <td align="left" style="width: 250px">
                                            &nbsp;<asp:TextBox ID="txtComputerSerialNbr" runat="server" Font-Names="Arial" Font-Size="9pt"
