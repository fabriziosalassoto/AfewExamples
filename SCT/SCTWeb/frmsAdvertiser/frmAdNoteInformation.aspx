<%@ Page Language="VB" MasterPageFile="~/frmsAdvertiser/MasterPage.master" AutoEventWireup="false" CodeFile="frmAdNoteInformation.aspx.vb" Inherits="frmsAdvertiser_frmAdNoteInformation" Title="Advertiser Note Information" %>
      ...
      <table cellpadding="0" cellspacing="0" style="padding-right: 0px; padding-left: 0px;
            ...
            <tr>
                <td style="height: 570px; font-size: 9pt; font-family: Arial;" align="center" valign="top">
                    ...
                    <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Size="14pt" Text="Note Information" Font-Names="Comic Sans MS"></asp:Label>&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="border-top: silver 1px solid; border-bottom: silver 1px solid;" colspan="2">
                                ...
                                <table style="width: 500px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" colspan="2" style="width: 250px">
                                            &nbsp;<asp:TextBox ID="txtAdNoteContact" runat="server" Font-Names="Arial" Font-Size="9pt"
                                ...
                                <asp:Menu ID="mnuContact" runat="server" DynamicHorizontalOffset="2" Font-Names="Comic Sans MS"
                                    ...
                                    <tr>
                                        <td align="right" style="font-size: 9pt; width: 250px; font-family: Arial">
                                            Date Entered:&nbsp;</td>
                                        <td align="left" colspan="2" style="width: 250px">
                                            &nbsp;<asp:TextBox ID="txtAdNoteDateEntered" runat="server" Font-Names="Arial" Font-Size="9pt" Width="200px" ReadOnly="True"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                    ...
                    <table style="width: 600px">
                        <tr>
                            <td align="right" style="height: 36px">
                                            <asp:Menu ID="mnuEditNote" runat="server" DynamicHorizontalOffset="2" Font-Names="Comic Sans MS"
