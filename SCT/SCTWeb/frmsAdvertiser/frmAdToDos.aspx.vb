...
Partial Class frmsAdvertiser_frmAdToDos
    Inherits System.Web.UI.Page

    Private wcForm As SCT.Web.DataFlow.DFClsAdToDos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Me.wcForm = New SCT.Web.DataFlow.DFClsAdToDos(Me)
        Else
            If SCT.Library.WebSite.ClsSessionAdmin.SessionCurrentClsForm Is Nothing OrElse SCT.Library.WebSite.ClsSessionAdmin.SessionCurrentClsForm.GetType().Name <> "DFClsAdToDos" Then
                Me.wcForm = New SCT.Web.DataFlow.DFClsAdToDos(Me)
            Else
    ...
    Protected Sub grdAdToDos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdAdToDos.RowDataBound
        SCT.Web.DataFlow.DFClsAdToDos.HidenMinDate(CType(sender, GridView), e.Row)
    End Sub
