<%@ Page Language="VB" MasterPageFile="~/frmsAdvertiser/MasterPage.master" AutoEventWireup="false" CodeFile="frmAdToDos.aspx.vb" Inherits="frmsAdvertiser_frmAdToDos" title="Advertiser To Do" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <table style="width: 450px">
        ...
        <tr>
            <td style="font-weight: normal; font-size: 10pt; vertical-align: top; width: 130px;
                font-family: Arial; text-align: right">
                <asp:CustomValidator ID="csvStartDate" runat="server" ErrorMessage="* Invalid Start Entered Date."
                    Font-Bold="True" Font-Names="Arial" Font-Size="Large" ForeColor="OrangeRed">*</asp:CustomValidator>Start
                Entered Date:</td>
            <td style="font-size: 10pt; vertical-align: top; font-family: Arial; text-align: left">
                <asp:DropDownList ID="ddlStartMonth" runat="server" Width="125px">
                ...
                ,&nbsp;<asp:DropDownList ID="ddlStartYear" runat="server" Width="90px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td style="font-weight: normal; font-size: 10pt; vertical-align: top; width: 130px;
                ...
                Entered Date:</td>
            <td style="font-size: 10pt; vertical-align: top; font-family: Arial; text-align: left">
                <asp:DropDownList ID="ddlEndMonth" runat="server" Width="125px">
                    <asp:ListItem></asp:ListItem>
                    <asp:ListItem Value="01">January</asp:ListItem>
                    <asp:ListItem Value="02">February </asp:ListItem>
                    <asp:ListItem Value="03">March</asp:ListItem>
                ...
                ,&nbsp;<asp:DropDownList ID="ddlEndYear" runat="server" Width="90px">
                </asp:DropDownList>
            </td>
        </tr>
    </table>
    ...
    <br />
    <asp:GridView ID="grdAdToDos" runat="server" AllowPaging="True" AllowSorting="True"
        AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid"
        BorderWidth="1px" CellPadding="2" Font-Bold="True"
        Font-Names="Comic Sans MS" Font-Overline="False" Font-Size="14pt" ForeColor="Black"
        PageSize="15" ShowFooter="True" UseAccessibleHeader="False" Width="800px">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DateEntered" HeaderText="Entered" SortExpression="DateEntered" DataFormatString="{0:MM/dd/yyyy}">
                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
            </asp:BoundField>
            <asp:BoundField DataField="DateCompleted" HeaderText="Completed" DataFormatString="{0:MM/dd/yyyy}" SortExpression="DateCompleted">
                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
            </asp:BoundField>
            <asp:BoundField DataField="Notes" HeaderText="Task Notes">
        ...
        <RowStyle Font-Bold="False" Font-Italic="False" Font-Names="Arial" Font-Size="9pt"
            ForeColor="Black" />
        <EmptyDataTemplate>
            <asp:Image ID="NoDataImage" runat="server" ImageUrl="~/Images/TODO16.BMP" />No
            Data Found to Show.
        </EmptyDataTemplate>
        ...
        <tr>
            <td align="right">
                <asp:Menu ID="cmdAddNew" runat="server" DynamicHorizontalOffset="2" Font-Names="Comic Sans MS"
                    ...
                    <DynamicMenuItemStyle HorizontalPadding="5px" VerticalPadding="2px" />
                    <Items>
                        <asp:MenuItem ImageUrl="~/Images/TODO16.BMP" Text=" Add New To Do" Value="AddNew">
                        </asp:MenuItem>
                    </Items>
