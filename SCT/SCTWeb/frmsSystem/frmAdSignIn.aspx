<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAdSignIn.aspx.vb" Inherits="frmsSystem_frmAdSignIn" %>
...
<head runat="server">
    <title>Notebook Detector - Advertiser Sign In</title>
<style type="text/css">
<!--
body { 
  ...
  <tr>
      ...
      <tr>
        <td bgcolor="#FFFFFF"><p><img src="../images/Logo-300X169.gif" alt="Logo" width="300" height="169" /></p>
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Names="Verdana"
                Font-Size="10pt" NavigateUrl="~/frmsSystem/frmAdSignUp.aspx">Sign Up Now</asp:HyperLink></td>
      </tr>
    </table>    
    <p>
    ...
    <td width="528" valign="top" bgcolor="#FFFFFF">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="443">
            <tr>
                <td colspan="2">
                    <span style="font-weight: bold; font-family: Verdana">Sign In as Advertiser</span>
                </td>
            </tr>
            <tr>
