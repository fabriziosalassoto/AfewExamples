...
Partial Class frmsSystem_frmAdSignIn
    Inherits System.Web.UI.Page

    Private wcform As SCT.Web.DataFlow.DFClsAdSignIn

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Me.wcform = New SCT.Web.DataFlow.DFClsAdSignIn(Me)
        Else
            If SCT.Library.WebSite.ClsSessionAdmin.SessionCurrentClsForm Is Nothing OrElse SCT.Library.WebSite.ClsSessionAdmin.SessionCurrentClsForm.GetType().Name <> "DFClsAdSignIn" Then
                Me.wcform = New SCT.Web.DataFlow.DFClsAdSignIn(Me)
            Else
